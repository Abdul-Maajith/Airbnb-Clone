  ...
  return (
    <div className="">
      ...
      <main className="max-w-7xl mx-auto px-8 sm:px-16">
        ...
        <section>
          <h2 className="text-2xl font-semibold py-8 pb-5">Live Anywhere</h2>
...
// Here in Next.js, we use getStaticProps() or getServerSide() to fetch data from the Api-endpoints instead of useEffect()!
