...
const Header = ({ placeholder }) => {
  ...
  const search = () => {
    ...
    return (
      <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-3.5 md:px-7">
        ...
        {/* Right */}
        <div className="flex text-sm items-center space-x-4 justify-end text-gray-500">
          <p className="hidden md:inline-flex lg:px-2">Become a host</p>
        ...
        {/* mx-auto centers itself in the left and right side! */}
        {searchInput && (
